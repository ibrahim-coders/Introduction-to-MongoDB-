...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.whh17.mongodb.net/coffeeDB?retryWrites=true&w=majority&appName=Cluster0`;
// console.log(uri);
...
app.get('/', (req, res) => {
  res.send('coffee making serder is runings');
});
